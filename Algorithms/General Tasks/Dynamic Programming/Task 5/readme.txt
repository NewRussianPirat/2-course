...
Найти наибольшее k, для которого существуют две последовательности индексов 0 <= i_1 < i_2 < ... < i_k < n и 0 <= j_1 < j_2 < ... < j_k < $,
что A_(i_1) = B_(j_1), A_(i_2) = B(_j_2), ..., A_(i_k) = B_(j_k). Также нужно найти и сами последовательности индексов.
